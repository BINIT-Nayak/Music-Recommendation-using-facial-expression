    ...
    if len(rects) > 0:
        ...
        if count > 20:
            if (label == "happy"):
                ...
                webbrowser.open('https://youtube.com/playlist?list=PLAQ7nLSEnhWTEihjeM1I-ToPDJEKfZHZu')    
                time.sleep(1)
                ...
                webbrowser.open('https://youtube.com/playlist?list=PL7v1FHGMOadBhCjuh_ljEEhqrQKCBsoIn')    
                time.sleep(1)
                ...
                cv2.destroyAllWindows()
                count = 0
                webbrowser.open('https://youtube.com/playlist?list=PLgzTt0k8mXzHcKebL8d0uYHfawiARhQja')    
                time.sleep(1)
                ...
                webbrowser.open('https://youtube.com/playlist?list=PLTjJ20VyWOu17NDKN2dwvba9DYYfLktYX')    
                time.sleep(2)
                ...
                webbrowser.open('https://youtu.be/DocQrkSeDRQ')    
                time.sleep(1)
                ...
                webbrowser.open('https://youtube.com/playlist?list=PL2hGGKKbxvqJ4ZsfBteqUaQF4tX41ylyk')    
                time.sleep(2)
